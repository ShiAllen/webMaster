...
import toolbar from './tinymce-components/f_toolbar'
import plugins from './tinymce-components/f_plugins'
  ...
  methods: {
    ...
    initTinymce() {
      ...
      //  language: this.languageTypeList['zh'],
        language: this.languageTypeList['tw'],
        height: this.height,
        body_class: 'panel-body ',
        object_resizing: false,
        toolbar: this.toolbar.length > 0 ? this.toolbar : toolbar,
        plugins, /// 外掛 plugins.js
