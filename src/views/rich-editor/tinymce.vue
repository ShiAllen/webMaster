...
const tinymceCDN = 'https://www.ncut.edu.tw/cdn/tinyMCE/510/tinymce.min.js'
  ...
  methods: {
    ...
    initTinymce() {
      ...
      window.tinymce.init({
        ...
        language: this.languageTypeList['tw'], // zh
        image_advtab: true,
       // external_filemanager_path: '/a/vue/tiny/Filemanager/',
       // external_plugins: {
       //   'filemanager': '/a/vue/tiny/filemanager/plugin.min.js'
       // }, // 外部插件js配置文件
        external_filemanager_path: '/ncut/news/Filemanager/',
        external_plugins: {
          'filemanager': '/ncut/news/filemanager/plugin.min.js'
        }, // 外部插件js配置文件
        height: this.height,
